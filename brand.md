...
<section id="linkedin" class="flex flex-col justify-center items-center py-8">
    <div class="border-2 border-emerald dark:border-forest mb-8" style="width: 1584px; height: 396px;">
        <div id="white-linkedin-bg" class="bg-white overflow-hidden relative z-[-1] flex flex-row items-center justify-end p-16" style="width: 1584px; height: 396px;">
            ...
            <img src="{{ '/assets/images/logo_light.svg' }}" alt="{{ site.title }}" class="h-32 w-auto z-10 mr-16">
        </div>
    </div>
