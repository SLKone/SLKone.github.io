---
layout: default
title: For Private Equity and Portfolio Companies
description: "Operating support across the investment lifecycle, sized for lean portfolio companies: diligence at speed, value creation, and exit readiness."
permalink: /private-equity-partnership
---
{% include page-header.html title="For Private Equity and Their Portfolio Companies" subtitle="Operating support across the investment lifecycle, sized for lean portfolio companies." background_image="/assets/images/backgrounds/private-equity.webp" color="tangerine" %}
...
<section class="py-20 lg:py-32">
  <div class="container mx-auto px-8 max-w-5xl">
    <h2 class="text-4xl mb-12 font-display">Why sponsors work with us</h2>
...
<section class="py-16">
  <div class="container mx-auto px-8 max-w-5xl">
    <div class="bg-black/5 dark:bg-currant-500 rounded-xl p-8 lg:p-12">
      <p class="text-2xl font-display mb-2">Backing a company that needs to move?</p>
      <p class="text-xl max-w-prose">Forward this to the management team, or talk to us directly about a Business Value Assessment on one portfolio company.</p>
    </div>
  </div>
</section>

{% include contact-card.html background_image="/assets/images/backgrounds/private-equity.webp" title="Talk to us about a portfolio company" description="We will read the business quickly and show you where the value is and how we would capture it." cta_link="/contact" cta_text="Talk to SLKone" %}
